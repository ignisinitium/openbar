...
"Create a new user", "Description: Creates a user with a given e-mail address and password."
...
Note that this JSON originates directly from the json_response() function.
